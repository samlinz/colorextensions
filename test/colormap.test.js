...
describe("ColorMap", () => {
    it("should create two-color colormaps", () => {
        ...
        let [fraction, startColor, stopColor] = colorMap.getColorsAndFraction(
            0
        );
        expect(fraction).toBeCloseTo(0);
        expect([startColor.r, startColor.g, startColor.b]).toEqual([0, 0, 0]);
        expect([stopColor.r, stopColor.g, stopColor.b]).toEqual([
            255,
            255,
            255
        ]);
    ...
    it("should create multiple-color colormaps", () => {
        ...
        [fraction, startColor, stopColor] = colorMap.getColorsAndFraction(0.23);
        ...
        [fraction, startColor, stopColor] = colorMap.getColorsAndFraction(0.6);
        ...
        [fraction, startColor, stopColor] = colorMap.getColorsAndFraction(0.75);
        expect(fraction).toBeCloseTo(1 / 6);
        expect([startColor.r, startColor.g, startColor.b]).toEqual([0, 0, 255]);
        expect([stopColor.r, stopColor.g, stopColor.b, stopColor.a]).toEqual([
            255,
            255,
            255,
            0.5
